    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                (textBox4.Enabled && Double.TryParse(textBox4.Text, out bottle_price) || !textBox4.Enabled))
            {
                ...
                {
                    mainFormHandle.curComp.AddAutomat(new MineralWaterAutomat(textBox1.Text, max_water, 0, 0, water_price, checkBox1.Checked,
                        checkBox3.Checked, checkBox2.Checked, 0, 0, textBox5.Text, checkBox3.Checked ? bottle_price : 0));

                    mainFormHandle.ReloadCombobox();
                    mainFormHandle.refresher();
                    this.Close();
                }
            }
        }
